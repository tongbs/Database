...
<html>
	...
	<body>
		...
		<div class="container register-wrapper">
			<form name="form1" action="http://localhost/db_final_example-master/auth/event_add.php" method="POST" onSubmit="return myCheck()"> 
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						<label>活動規則</label>
						<input type="text" name="event_rule" class="form-control">
						<br><br>
					</div>
					<div class="col-md-5 col-md-offset-1">
						<label>隊伍限制</label>
						<input type="text" name="event_team" class="form-control">
						<br><br>
					</div>
					<div class="col-md-5 col-md-offset-1">
						<label>每隊人數限制</label>
						<input type="text" name="event_team_limit" class="form-control">
						<br><br>
					</div>
					<div class="col-md-6 col-md-offset-9">
						<button type="submit" class="btn btn-success btn-login" value="submit">發佈</button>
