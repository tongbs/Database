<?php
  ...
  $auth= new Auth();
  $edit = $auth->get_edit_article($_GET['id']);
...
<html>
	...
	<body>
		...
		<div class="container register-wrapper">
			<form name="form1" action="http://localhost/db_final_example-master/admin/update_article.php" method="POST" onSubmit="return myCheck()"> 
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<label>公告內容</label>
						<br>
						<textarea name="content" style="width:500px;height:300px;" ><?php echo nl2br($edit['content']);?></textarea>
						<br><br><br>
					</div>
